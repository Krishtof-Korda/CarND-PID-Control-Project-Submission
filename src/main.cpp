...
int main()
{
  ...
  // Steerin control initialization
  ...
  // Throttle control initialization
    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2')
    {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          double steer_value;
          double throttle_value; // throttle variable
          const double cruise_speed = 60; // Target speed for cruise control
